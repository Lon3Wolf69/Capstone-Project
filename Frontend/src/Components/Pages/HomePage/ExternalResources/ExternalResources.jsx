import { ExternalRoutes } from "./ExternalRoutes.jsx";                // Importing the Redirect buttton generating code as variable external resources
import "./ExternalResources.css";                                       // Importing the Redirect button css styling sheet


function ExternalResources() {

    const allResources = ExternalRoutes.flatMap(column => column.children);
